...
public abstract class AbstractCommandParser implements CommandParser {
    ...
    protected Map<String, ? extends Class<CmdBase>> traceAllCmdClass() {
        ...
        String coreJarLocationPath = AbstractCommandParser.class.getProtectionDomain().getCodeSource().getLocation().getPath();
...
//        String pkg = "billy.rpg.game.core.command."; hard-code style
        String commandParserPath = AbstractCommandParser.class.getPackage().getName();
