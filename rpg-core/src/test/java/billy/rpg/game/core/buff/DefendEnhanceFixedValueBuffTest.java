...
public class DefendEnhanceFixedValueBuffTest extends GameContainerTestBase {

    private DefendEnhanceFixedValueBuff buff;
    ...
    public void before() {
        super.before();
        buff = new DefendEnhanceFixedValueBuff(fixedValue, lastRounds);
    }
